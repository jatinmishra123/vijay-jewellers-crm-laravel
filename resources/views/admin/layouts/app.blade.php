    ...
    <div id="layout-wrapper">
        ...
        <aside class="new-sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.schemes.index') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.scheme_payments.index') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.lucky_draws.index') }}">
                        <i class="ri-gift-fill"></i> <span>Lucky Draws</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.exports.dashboard') }}">
                        ...
                        <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                            ...
                            <span class="d-flex align-items-center">
                                ...
                                <span class="text-start ms-2">
                                    <span class="d-none d-xl-inline-block fw-medium">{{ $user->name ?? 'Admin' }}</span>
                                    <span
                                        class="d-none d-xl-block fs-12 text-muted">{{ $user && $user->role ? $user->role->name : 'Role' }}</span>
                                </span>
                            </span>
                        </button>
