...
<head>
    <meta charset="utf-8" />
    <title>@yield('title', 'Admin Dashboard - Vijay Jewellers')</title>
    ...
    <div id="layout-wrapper">
        ...
        <aside class="new-sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ str_contains($currentRoute, 'admin.roles') ? 'active' : '' }}" href="{{ route('admin.roles.index') }}">
                        <i class="ri-user-settings-line"></i> <span>Roles</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ str_contains($currentRoute, 'admin.customers') ? 'active' : '' }}" href="{{ route('admin.customers.index') }}">
                        <i class="ri-user-3-line"></i> <span>Customers</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ str_contains($currentRoute, 'admin.sales') ? 'active' : '' }}" href="{{ route('admin.sales.index') }}">
                        <i class="ri-bar-chart-2-line"></i> <span>Total Sales</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ str_contains($currentRoute, 'admin.schemes') ? 'active' : '' }}" href="{{ route('admin.schemes.index') }}">
                        <i class="ri-stack-fill"></i> <span>Total Scheme</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ str_contains($currentRoute, 'payments.index') ? 'active' : '' }}" href="{{ route('payments.index') }}">
                        <i class="ri-money-dollar-circle-line"></i> <span>Payment Report</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ str_contains($currentRoute, 'admin.scheme_payments') ? 'active' : '' }}" href="{{ route('admin.scheme_payments.index') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ str_contains($currentRoute, 'admin.lucky_draws') ? 'active' : '' }}" href="{{ route('admin.lucky_draws.index') }}">
                        <i class="ri-gift-fill"></i> <span>Lucky Draws</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ str_contains($currentRoute, 'admin.exports') ? 'active' : '' }}" href="{{ route('admin.exports.dashboard') }}">
                        <i class="ri-file-download-line"></i> <span>Export Report</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ str_contains($currentRoute, 'admin.contacts') ? 'active' : '' }}" href="{{ route('admin.contacts.index') }}">
                        <i class="bi bi-chat-dots"></i> <span>Follow Up</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ str_contains($currentRoute, 'admin.manage') ? 'active' : '' }}" href="{{ route('admin.manage.index') }}">
                    ...
                    <div class="dropdown">
                        <button type="button" class="user-dropdown-btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                            ...
                            <img class="user-avatar"
                                src="{{ asset('assets/assets/images/users/avatar-1.jpg') }}" alt="Header Avatar">
                            <div class="user-info d-none d-md-block">
                                <div class="user-name">{{ $user->name ?? 'Admin' }}</div>
                                <div class="user-role">{{ $user && $user->role ? $user->role->name : 'Role' }}</div>
                            </div>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">
                            <h6 class="dropdown-header">Welcome {{ $user->name ?? 'Admin' }}!</h6>
