...
<?php $__env->startSection('title', 'Lucky Draw - Vijay Jewellers'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    $cards = [
        ...
        ['title' => 'Reward Sent', 'count' => $summary['reward_sent'] ?? 0, 'icon' => 'bi-gift-fill', 'bg' => 'linear-gradient(135deg,#6f42c1,#5a2d91)', 'text' => 'text-white'],
                ...
                <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-sm-6 col-md-3">
                        <div class="card shadow-sm <?php echo e($card['text']); ?>"
                            style="background: <?php echo e($card['bg']); ?>; border-radius:12px; border: none;">
                            <div class="card-body text-center py-3">
                                ...
                                <h4 class="mb-0 fs-3 fw-bold"><?php echo e(number_format($card['count'])); ?></h4>
                    ...
                    <div class="card shadow-sm h-100">
                        ...
                        <div class="card-body">
                            <form class="row g-3 align-items-center" method="GET"
                                action="<?php echo e(route('admin.lucky_draws.index')); ?>">
                                <div class="col-md-4">
                                    <label for="search" class="form-label small text-muted">Search</label>
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-text"><i class="bi bi-search"></i></span>
                                        <input type="text" name="search" class="form-control"
                                            placeholder="Customer, coupon code..." value="<?php echo e(request('search')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="reward_status" class="form-select form-select-sm">
                                        ...
                                        <option value="pending" <?php echo e(request('reward_status') == 'pending' ? 'selected' : ''); ?>>
                                            Pending</option>
                                        <option value="sent" <?php echo e(request('reward_status') == 'sent' ? 'selected' : ''); ?>>Sent
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12 mt-3">
                                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                                        ...
                                        <div class="mt-2 mt-md-0">
                                            <a href="<?php echo e(route('admin.lucky_draws.export', array_merge(['type' => 'csv'], request()->all()))); ?>"
                                                class="btn btn-success btn-sm me-2">
                                                <i class="bi bi-file-earmark-spreadsheet-fill me-1"></i> CSV
                                            </a>
                                            <a href="<?php echo e(route('admin.lucky_draws.export', array_merge(['type' => 'excel'], request()->all()))); ?>"
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-primary"><?php echo e($luckyDraws->total()); ?> records</span>
                </div>
                ...
                <div class="card-body p-3">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $luckyDraws; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $draw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <tr class="align-middle">
                                                        <td class="text-center"><?php echo e($draw->id); ?></td>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div><?php echo e(optional($draw->customer)->name ?? '-'); ?></div>
                                                            </div>
                                                        </td>
                                                        <td><?php echo e(optional($draw->scheme)->name ?? '-'); ?></td>
                                                        <td><?php echo e(optional($draw->schemePayment)->id ?? '-'); ?></td>
                                                        <td>
                                                            <span
                                                                class="badge bg-light text-dark font-monospace p-2"><?php echo e($draw->coupon_code); ?></span>
                                                        </td>
                                                        <td class="text-end fw-bold">
                                                            ₹<?php echo e($draw->lucky_draw_amount ? number_format($draw->lucky_draw_amount, 2) : '0.00'); ?>

                                                        </td>
                                                        <td class="text-center">
                                                            <span class="badge py-2 px-3 
                                                                                                                                                            <?php echo e($draw->status == 'pending' ? 'bg-warning text-dark' :
            ($draw->status == 'used' ? 'bg-success' :
                ($draw->status == 'cancelled' ? 'bg-danger' : 'bg-secondary'))); ?>">
                                                                <i class="bi 
                                                                                                                                                                <?php echo e($draw->status == 'pending' ? 'bi-clock-history' :
            ($draw->status == 'used' ? 'bi-check-circle' :
                ($draw->status == 'cancelled' ? 'bi-x-circle' : 'bi-question-circle'))); ?> me-1">
                                                                </i>
                                                                <?php echo e(ucfirst($draw->status)); ?>

                                                            </span>
                                                        </td>
                                                        <!-- New Reward Columns -->
                                                        <td class="text-center"><?php echo e($draw->reward_type ?? '-'); ?></td>
                                                        <td class="text-center"><?php echo e($draw->reward_value ?? '-'); ?></td>
        ...
        $shortMessage = implode(' ', array_slice($words, 0, 10));
                                                            ?>
                                                            <?php echo e(count($words) > 10 ? $shortMessage . '...' : $draw->reward_message); ?>

                                                            <?php if(count($words) > 10): ?>
                                                                <a href="#" class="ms-1 view-full-message" data-bs-toggle="modal"
                                                                    data-bs-target="#rewardMessageModal" data-message="<?php echo e($draw->reward_message); ?>">Read
                                                                    More</a>
                                                            <?php endif; ?>
                                                        </td>
                                                        </td>
                                                        <td class="text-center">
                                                            <?php if($draw->reward_status === 'sent'): ?>
                                                        ...
                                                        <td class="text-center">
                                                            <?php echo e($draw->rewarded_at ? \Carbon\Carbon::parse($draw->rewarded_at)->format('d M Y H:i') : '-'); ?>

                                                        </td>

                                                        <td class="text-center"><?php echo e($draw->created_at->format('d M Y')); ?></td>
                                                        <td class="text-center">
                                                            <div class="d-flex justify-content-center">
                                                                <button class="btn btn-sm btn-outline-info me-1 view-btn" data-bs-toggle="modal"
                                                                    data-bs-target="#viewModal" data-id="<?php echo e($draw->id); ?>"
                                                                    data-customer="<?php echo e(optional($draw->customer)->name ?? 'N/A'); ?>"
                                                                    data-scheme="<?php echo e(optional($draw->scheme)->name ?? 'N/A'); ?>"
                                                                    data-amount="<?php echo e($draw->lucky_draw_amount ? number_format($draw->lucky_draw_amount, 2) : '0.00'); ?>"
                                                                    data-code="<?php echo e($draw->coupon_code); ?>"
                                                                    data-created="<?php echo e($draw->created_at->format('d M Y')); ?>"
                                                                    data-status="<?php echo e($draw->status); ?>"
                                                                    data-reward-status="<?php echo e($draw->reward_status); ?>"
                                                                    data-reward-type="<?php echo e($draw->reward_type); ?>"
                                                                    data-reward-value="<?php echo e($draw->reward_value); ?>"
                                                                    data-reward-message="<?php echo e($draw->reward_message); ?>"
                                                                    title="View Details & Add Reward">
                                                                    <i class="bi bi-eye"></i>
                                                                </button>
                                                                <form action="<?php echo e(route('admin.lucky_draws.destroy', $draw->id)); ?>" method="POST"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <!-- Pagination -->
                    <?php if($luckyDraws->hasPages()): ?>
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <div class="text-muted small">
                                Showing <?php echo e($luckyDraws->firstItem()); ?> to <?php echo e($luckyDraws->lastItem()); ?> of
                                <?php echo e($luckyDraws->total()); ?> entries
                            </div>
                            <nav>
                                <?php echo e($luckyDraws->withQueryString()->links()); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Downloads\vijay_jwellers\resources\views/admin/lucky_draws/index.blade.php ENDPATH**/ ?>