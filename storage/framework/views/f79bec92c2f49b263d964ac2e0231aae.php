...
<?php $__env->startSection('title', 'Sales - Admin Dashboard'); ?>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0">rs<?php echo e(number_format($dailySales->total_sales ?? 0, 2)); ?></h4>
                        </div>
                    ...
                    <div class="mt-3">
                        ...
                        ?>
                        <p class="mb-0"><span class="badge <?php echo e($badgeClass); ?> me-1"><?php echo e($changeText); ?></span> vs. yesterday
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0">$<?php echo e(number_format($dailySales->online_sales ?? 0, 2)); ?></h4>
                        </div>
                        <div class="flex-shrink-0">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0">$<?php echo e(number_format($dailySales->offline_sales ?? 0, 2)); ?></h4>
                        </div>
                        <div class="flex-shrink-0">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0">$<?php echo e(number_format($dailySales->avg_order_value ?? 0, 2)); ?></h4>
                        </div>
                        <div class="flex-shrink-0">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive mt-3">
                        <table class="table table-sm table-centered table-nowrap table-borderless mb-0">
                            <tbody>
                                <?php $__currentLoopData = $productTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <tr>
                                        <td style="width: 30%">
                                            <p class="mb-0"><?php echo e($type); ?></p>
                                        </td>
                                        <td style="width: 25%">
                                            <h5 class="mb-0">$<?php echo e(number_format($amount, 2)); ?></h5>
                                        </td>
                                        <td style="width: 25%">
                                            <div class="progress progress-sm">
                                                <div class="progress-bar <?php echo e($colors[$index]); ?>" role="progressbar"
                                                    style="width: <?php echo e($percentage); ?>%" aria-valuenow="<?php echo e($percentage); ?>"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </td>
                                        <td style="width: 20%">
                                            <p class="text-muted mb-0"><?php echo e(number_format($percentage, 1)); ?>%</p>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                    <img src="https://via.placeholder.com/40" alt="<?php echo e($product->product_name); ?>"
                                                        class="avatar-sm rounded-circle">
                                                </div>
                                                <div class="flex-grow-1"><?php echo e($product->product_name); ?></div>
                                            </div>
                                        </td>
                                        <td>$<?php echo e(number_format($product->avg_price, 2)); ?></td>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div id="sales-table" class="table-responsive">
                        <?php echo $__env->make('admin.sales.partials.table', ['sales' => $sales], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            function loadSales(query = '', page = 1) {
                $.ajax({
                    url: '<?php echo e(route('admin.sales.index')); ?>',
                    method: 'GET',
            ...
            $('#confirmDeleteBtn').on('click', function () {
                ...
                let url = '<?php echo e(route("admin.sales.destroy", ":id")); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Downloads\vijay_jwellers\resources\views/admin/sales/index.blade.php ENDPATH**/ ?>