                    ...
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <h4 class="mb-0 fw-semibold fs-6"><?php echo e($stats['today_new']); ?></h4>
                            </div>
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <h4 class="mb-0 fw-semibold fs-6"><?php echo e($stats['active_count']); ?></h4>
                            </div>
                            <div class="flex-shrink-0">
                                <div class="avatar-xs">
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <h4 class="mb-0 fw-semibold fs-6"><?php echo e($stats['inactive_pending_count']); ?></h4>
                            </div>
                            <div class="flex-shrink-0">
                                <div class="avatar-xs">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item small"
                                                href="<?php echo e(route('exports.pdf', 'customers')); ?>">PDF</a></li>
                                        <li><a class="dropdown-item small"
                                                href="<?php echo e(route('exports.excel', 'customers')); ?>">Excel</a></li>
                                        <li><a class="dropdown-item small"
                                                href="<?php echo e(route('exports.csv', 'customers')); ?>">CSV</a></li>
                                    </ul>
                                </div>
                                <a href="<?php echo e(route('admin.customers.create')); ?>" class="btn btn-sm btn-primary">
                            ...
                            <div class="col-md-4">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" id="searchInput" class="form-control form-control-sm"
                                        placeholder="Search customers..." value="<?php echo e(request('search')); ?>"
                                        autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-3">
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.btn-verify', function () {
                ...
                if (notes !== null) {
                    $.ajax({
                        url: '<?php echo e(url('admin/customers')); ?>/' + customerId + '/verify',
                        method: 'POST',
                        data: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Downloads\vijay_jwellers\resources\views/admin/customers/index.blade.php ENDPATH**/ ?>